...
are committed. Earlier runs with the layer-warning overlay or the desert
...
|---|---:|---:|---:|---:|---:|---:|
| 1× | 0.6 | 0.8 | 1.2 | 0 | 0 | 0 / 0 |
| 4× | 2 | 2.6 | 3.5 | 0 | 0 | 0 / 0 |
| 6× | 3.3 | 4.5 | 7 | 0 | 0 | 1 / 1 |

At 6×, one missed interval occurred on each side. All update samples stayed below
16 ms and no long tasks were observed. The Wave 1 guard performed zero unchanged
hint scans during the measured windows. Recreated non-trade layer objects remain
